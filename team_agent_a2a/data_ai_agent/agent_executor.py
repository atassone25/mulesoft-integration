"""Agent Executor for Data AI Agent - handles A2A task execution"""
import logging
import asyncio
import sys
import os
...
class DataAIAgentExecutor(AgentExecutor):
    """Executor for Data AI Agent A2A tasks"""
    ...
    def __init__(self, runner: Runner, card: AgentCard):
        ...
        self.logger = logger
        self._card = card
        self.logger.info(f"DataAIAgentExecutor initialized for agent: {runner.agent.name}")
    ...
    async def execute(
        ...
        initial_message = new_agent_text_message("Request received, starting Data AI search...", context.context_id, context.task_id)
            ...
            async for event in self.runner.run_async(
                ...
                for part in event.content.parts:
                    if part.function_call:
                        ...
                        status_text = f"Executing search tool: '{tool_name}'..."
